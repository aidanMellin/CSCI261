...
public class KthLargest{
	/*
	 * Because no array manipulation is going to be allowed, given that is has a time complexity of O(log(N))
	*/
	...
	/*
	 * This method creates the tree, inserts all components of given list a
	 * and then finds Kth largest value, and returns it for TestKthLargest
	*/
